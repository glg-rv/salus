...
impl HypPageTable {
    ...
    /// mapper will map pages in User writable, otherwhise will be mapped User-readable.
...
impl UmodeSlotMapper<'_> {
    ...
    /// # Safety
    ///
    /// Caller must guarantee that the page at page `paddr` is owned by a guest and has been shared with the hypervisor.
